    ...
    <main className="space-y-4 max-w-xs md:max-w-4xl w-full h-full mx-auto flex flex-col justify-center items-center">
      <div className="flex items-center">
        <h1 className={cn(oregano.className, "text-white px-1.5")}>
          <span className="px-2 py-1 text-2xl font-bold rounded-tl-2xl rounded-tr-3xl rounded-br-lg rounded-bl-[2.5em] bg-gradient-to-br from-teal-900 via-teal-950 to-[#0d1e21]">
            C
          </span>
        </h1>
