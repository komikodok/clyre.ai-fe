    ...
    <>
      <div className="flex-1 w-full h-full">
        <ScrollArea className="py-14 max-w-xs md:max-w-4xl h-[90%] mx-auto">
          <UserMessage 
            content="Lorem ipsum dolor sit amet consectetur adipisicing elit. Iusto quasi earum odio quo iste hic voluptas culpa animi fuga! Ab eaque tenetur beatae veli t, suscipit aut! Itaque nemo quod distinctio." 
          />
          <AIMessage 
            content={[
              "# Lorem\n",
